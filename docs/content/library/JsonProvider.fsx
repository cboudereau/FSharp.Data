...
//XmlSample.GetSample().XElement.Document.Descendants()
//|> Seq.map (fun x -> x.Name.LocalName)
//|> Seq.groupBy id

//type Xml2Sample = XmlProvider<"""
//    <root>
//        <child><id>1</id></child>
//        <child2><id>1</id></child2>
//    </root>""">
...
//type GlobalInference = JsonProvider<"""{
//"id": 1234,
//"t" : { "firstname":"clem" },
//"children": [
//  {
...
//type Simple = JsonProvider<""" { "name":"John", "age":94 } """, Global=false>
